...
public class SootTutorielCreateClass
{
    public static void main(String[] args) throws FileNotFoundException, IOException
    {
    		//Set the Soot's ClassPath
        ...
        String fileName = SourceLocator.v().getFileNameFor(sClass, Options.output_format_class); /*could be : output_format_jimple*/
